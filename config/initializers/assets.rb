...
Rails.application.config.assets.precompile += %w( drinks/drinks.js )
Rails.application.config.assets.precompile += %w( drinks/drinks.factory.js )
Rails.application.config.assets.precompile += %w( drinks/drinks.controller.js )
